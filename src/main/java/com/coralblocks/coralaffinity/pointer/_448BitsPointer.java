...
public class _448BitsPointer extends Pointer {
	...
	public _448BitsPointer(long l1, long l2, long l3, long l4, long l5, long l6, long l7) {
		super(SIZE_IN_BYTES);
	...
	@Override
	public void reset() {
		set(0L, 0L, 0L, 0L, 0L, 0L, 0L);
	}
	
	private void set(long l1, long l2, long l3, long l4, long l5, long l6, long l7) {
